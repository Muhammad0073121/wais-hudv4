...
let stressValue = 0,
  ...
  thirstValue = 0,
  staminaValue = 0,
  playerInWeater = false;

let hudType = localStorage.getItem("hudtype")
  ? localStorage.getItem("hudtype")
  : localStorage.setItem("hudtype", "square")
  ? localStorage.getItem("hudtype")
  : localStorage.getItem("hudtype");
let healColor = localStorage.getItem("healcolor")
  ? localStorage.getItem("healcolor")
  : localStorage.setItem("healcolor", undefined)
  ? localStorage.getItem("healcolor")
  : localStorage.getItem("healcolor");
let armourColor = localStorage.getItem("armourcolor")
  ? localStorage.getItem("armourcolor")
  : localStorage.setItem("armourcolor", undefined)
  ? localStorage.getItem("armourcolor")
  : localStorage.getItem("armourcolor");
let hungerColor = localStorage.getItem("hungercolor")
  ? localStorage.getItem("hungercolor")
  : localStorage.setItem("hungercolor", undefined)
  ? localStorage.getItem("hungercolor")
  : localStorage.getItem("hungercolor");
let thirstColor = localStorage.getItem("thirstcolor")
  ? localStorage.getItem("thirstcolor")
  : localStorage.setItem("thirstcolor", undefined)
  ? localStorage.getItem("thirstcolor")
  : localStorage.getItem("thirstcolor");
let staminaColor = localStorage.getItem("staminacolor")
  ? localStorage.getItem("staminacolor")
  : localStorage.setItem("staminacolor", undefined)
  ? localStorage.getItem("staminacolor")
  : localStorage.getItem("staminacolor");
let stressColor = localStorage.getItem("pstresscolor")
  ? localStorage.getItem("pstresscolor")
...
let speedType = localStorage.getItem("speedtype")
  ? localStorage.getItem("speedtype")
  : localStorage.setItem("speedtype", "kmh")
  ? localStorage.getItem("speedtype")
  : localStorage.getItem("speedtype");

let cashBankShow = localStorage.getItem("showmoney")
  ? localStorage.getItem("showmoney")
  : localStorage.setItem("showmoney", "show")
  ? localStorage.getItem("showmoney")
  : localStorage.getItem("showmoney");
let keybindShow = localStorage.getItem("showkeybind")
  ? localStorage.getItem("showkeybind")
  : localStorage.setItem("showkeybind", "show")
  ? localStorage.getItem("showkeybind")
  : localStorage.getItem("showkeybind");
let jobShow = localStorage.getItem("showjob")
  ? localStorage.getItem("showjob")
  : localStorage.setItem("showjob", "show")
  ? localStorage.getItem("showjob")
  : localStorage.getItem("showjob");
let clockShow = localStorage.getItem("showClock")
  ? localStorage.getItem("showClock")
  : localStorage.setItem("showClock", "show")
  ? localStorage.getItem("showClock")
  : localStorage.getItem("showClock");

let healPosition = localStorage.getItem("heal-position")
  ? localStorage.getItem("heal-position")
  : localStorage.setItem("heal-position", undefined)
  ? localStorage.getItem("heal-position")
  : localStorage.getItem("heal-position");
let armourPosition = localStorage.getItem("armour-position")
  ? localStorage.getItem("armour-position")
  : localStorage.setItem("armour-position", undefined)
  ? localStorage.getItem("armour-position")
  : localStorage.getItem("armour-position");
let hungerPosition = localStorage.getItem("hunger-position")
  ? localStorage.getItem("hunger-position")
  : localStorage.setItem("hunger-position", undefined)
  ? localStorage.getItem("hunger-position")
  : localStorage.getItem("hunger-position");
let thirstPosition = localStorage.getItem("thirst-position")
  ? localStorage.getItem("thirst-position")
  : localStorage.setItem("thirst-position", undefined)
  ? localStorage.getItem("thirst-position")
  : localStorage.getItem("thirst-position");
let staminaPosition = localStorage.getItem("stamina-position")
  ? localStorage.getItem("stamina-position")
  : localStorage.setItem("stamina-position", undefined)
  ? localStorage.getItem("stamina-position")
  : localStorage.getItem("stamina-position");

let streetPosition = localStorage.getItem("street-position")
  ? localStorage.getItem("street-position")
  : localStorage.setItem("street-position", undefined)
  ? localStorage.getItem("street-position")
  : localStorage.getItem("street-position");
let carhudPosition = localStorage.getItem("carhud-position")
  ? localStorage.getItem("carhud-position")
...
$("input").change(function (e) {
  if (e.target.type == "checkbox") {
    ...
    if (id == "speed-type") {
      ...
      if (value) {
        ...
        cinematicMode(true);
        $.post(
          "http://wais-hudv4/cinematic",
          JSON.stringify({ cinematic: true })
        );
      } else {
        ...
        $.post(
          "http://wais-hudv4/cinematic",
          JSON.stringify({ cinematic: false })
        );
      }
    } else if (id == "jobitem") {
      if (value) {
  ...
  $(`.container-prog[data-hud="${$(this).attr("id")}"]`)
    .children("svg")
    .find("path")
    .eq(1)
    .css({
...
$(".container").draggable({
  stop: function (event, ui) {
    if (
      event.target.dataset.hud == "pstress" ||
      event.target.dataset.hud == "stamina"
    ) {
      if (event.target.dataset.hud == "pstress") {
        $('.container[data-hud="stamina"]').attr(
          "style",
          $(`.container[data-hud="${event.target.dataset.hud}"]`).attr("style")
        );
      } else if (event.target.dataset.hud == "stamina") {
        $('.container[data-hud="pstress"]').attr(
          "style",
          $(`.container[data-hud="${event.target.dataset.hud}"]`).attr("style")
        );
      }
      ...
      localStorage.setItem(
        `${event.target.dataset.hud}-position`,
        $(`.container[data-hud="${event.target.dataset.hud}"]`).attr("style")
      );
    }
  },
...
$(document).on("click", ".item-selection-button", function () {
  if (!cooldown) {
    ...
    $('.item-selection-button[data-state="true"]')
      .children("i")
      .eq(0)
      .fadeOut(250);
    ...
    $('.item-selection-button[data-state="true"]')
      ...
      .fadeIn(250);
    $(
      `#hudtype-texts[data-name=${type == "square" ? "round" : "square"}]`
...
$(document).on("click", ".map-select-button", function () {
  if (!cooldown) {
    ...
    $(
      `.map-select-button[data-mapname="${
    ...
    $(`.map-select-button[data-mapname="${type}"]`)
      .children("span")
      .eq(0)
      .html("Selected");
    $(`.map-select-button[data-mapname="${type}"]`)
...
function updateMoneys3(cash) {
  if (cash == 0) {
    $("#blackmoney-container").remove();
    return;
  }
  if ($("#blackmoney-container").length == 0) {
    const newDiv = `
        <div id="blackmoney-container" class="bank">
            <span id="player-black-money">$ ${addCommas(
              String(cash)
            )}</span><i id="player-black-money-icon" class="fa-solid fa-money-bill"></i>
        </div>
    `;
    $("#bank-container").after(newDiv);
    return;
  }
  $("#player-black-money").html(`$ ${addCommas(String(cash))}`);
}
...
function updateVehicleStatus(
  ...
  $(".fuel-prog").animate(
    { "stroke-dasharray": 773 + parseInt(fuel * 1.15) },
    1
  );
  ...
  $("#belt").attr(
    "src",
    `./img/speedm-images/${belt ? "belt-on" : "belt"}.png`
  );
  $("#door").attr(
    "src",
    `./img/speedm-images/${door ? "door-on" : "door"}.png`
  );
  $("#lights").attr(
    "src",
    `./img/speedm-images/${light ? "lights-on" : "lights"}.png`
  );
  $("#engine").attr(
    "src",
    `./img/speedm-images/${engine ? "engine-on" : "engine"}.png`
  );
  $("#brake").attr(
    "src",
    `./img/speedm-images/${hbreake ? "brake-on" : "brake"}.png`
  );
  $("#spped-limiter").attr(
    "src",
    `./img/speedm-images/${limiter ? "meter-on" : "meter"}.png`
  );
  $("#wrench").attr(
    "src",
    `./img/speedm-images/${
      parseInt(damage / 10) <= 50 ? "wrench-on" : "wrench"
    }.png`
  );
...
function buildSettings(resetSettings) {
  if (resetSettings && resetSettings != undefined) {
    ...
    $(`.map-select-button[data-mapname="circle"]`)
      .children("span")
      .eq(0)
      .html("Select");
    $(`.map-select-button[data-mapname="circle"]`)
    ...
    setTimeout(() => {
      ...
      $(`.map-select-button[data-mapname="round"]`)
        .children("span")
        .eq(0)
        .html("Selected");
      $(`.map-select-button[data-mapname="round"]`)
  ...
  $(
    `.item-selection-button[data-hud-type=${
      hudType == "circle" ? "round" : "square"
    }]`
  ...
  $(
    ...
    .fadeIn(250);
  $(
    `#hudtype-texts[data-name=${hudType == "circle" ? "round" : "square"}]`
  ).attr("data-state", "true");
  $(".container-prog").addClass(`${hudType}`);

  $(
    `.map-select-button[data-mapname="${
      mapType == "circle" ? "round" : "circle"
    }"]`
  )
    .children("span")
    .eq(0)
  ...
  $(`.map-select-button[data-mapname="${mapType}"]`)
    .children("span")
    .eq(0)
    .html("Selected");
  $(`.map-select-button[data-mapname="${mapType}"]`)
...
function renderProgBras() {
  ...
  $('.container[data-hud="heal"]').attr(
    "style",
    `${
      healPosition != "undefined" || healPosition != undefined
        ? healPosition
        : ""
    }`
  );
  $('.container[data-hud="armour"]').attr(
    "style",
    `${
      armourPosition != "undefined" || armourPosition != undefined
        ? armourPosition
        : ""
    }`
  );
  $('.container[data-hud="hunger"]').attr(
    "style",
    `${
      hungerPosition != "undefined" || hungerPosition != undefined
        ? hungerPosition
        : ""
    }`
  );
  $('.container[data-hud="thirst"]').attr(
    "style",
    `${
      thirstPosition != "undefined" || thirstPosition != undefined
        ? thirstPosition
        : ""
    }`
  );
  $('.container[data-hud="stamina"]').attr(
    "style",
    `${
      staminaPosition != "undefined" || staminaPosition != undefined
        ? staminaPosition
        : ""
    }`
  );
  ...
  $(".street-mic").attr(
    "style",
    `${
      streetPosition != "undefined" || streetPosition != undefined
        ? streetPosition
        : ""
    }`
  );
  ...
  $('.container-prog[data-hud="heal"]').css({
    background: `linear-gradient(0deg, ${
      healColor == "undefined" ? "rgba(231,189,136,0.5)" : healColor + "50"
    } 0%, rgba(0,0,0,0) 100%)`,
  });
  ...
  $('.container-prog[data-hud="armour"]').css({
    background: `linear-gradient(0deg, ${
      armourColor == "undefined" ? "rgba(184,168,255,0.5)" : armourColor + "50"
    } 0%, rgba(0,0,0,0) 100%)`,
  });

  $('.container-icon[data-hud="armour"]').css({
    color: `${
      armourColor == "undefined" ? "rgba(184,168,255,1)" : armourColor
    }`,
  });

  $('.container-prog[data-hud="hunger"]').css({
    background: `linear-gradient(0deg, ${
      hungerColor == "undefined" ? "rgba(86,232,242,0.5)" : hungerColor + "50"
    } 0%, rgba(0,0,0,0) 100%)`,
  });
  ...
  $('.container-prog[data-hud="thirst"]').css({
    background: `linear-gradient(0deg, ${
      thirstColor == "undefined" ? "rgba(111,212,13,0.5)" : thirstColor + "50"
    } 0%, rgba(0,0,0,0) 100%)`,
  });
  ...
  $('.container-icon[data-hud="stamina"]').css({
    color: `${
      staminaColor == "undefined" ? "rgba(255,255,255,1)" : staminaColor
    }`,
  });

  $('.container-prog[data-hud="pstress"]').css({
    background: `linear-gradient(0deg, ${
      stressColor == "undefined" ? "rgba(197, 7, 7,0.5)" : stressColor + "50"
    } 0%, rgba(0,0,0,0) 100%)`,
  });
  ...
  $(`.color[data-name="heal"]`).css({
    background: `${
      healColor == "undefined" ? "rgba(255, 255, 255, 0.02)" : healColor
    }`,
  });

  $(`.color[data-name="armour"]`).css({
    background: `${
      armourColor == "undefined" ? "rgba(255, 255, 255, 0.02)" : armourColor
    }`,
  });

  $(`.color[data-name="hunger"]`).css({
    background: `${
      hungerColor == "undefined" ? "rgba(255, 255, 255, 0.02)" : hungerColor
    }`,
  });

  $(`.color[data-name="thirst"]`).css({
    background: `${
      thirstColor == "undefined" ? "rgba(255, 255, 255, 0.02)" : thirstColor
    }`,
  });

  $(`.color[data-name="stamina"]`).css({
    background: `${
      staminaColor == "undefined" ? "rgba(255, 255, 255, 0.02)" : staminaColor
    }`,
  });

  $(`.color[data-name="pstress"]`).css({
    background: `${
      stressColor == "undefined" ? "rgba(197, 7, 7, 0.02)" : stressColor
    }`,
  });
          ...
          type == "information" ? "info" : type
            ...
            ${
              type == "information"
                ...
                : console.log("Error! this notification type not have." + type)
            }
            <span>${type}</span>
        </div>
...
function resetDefault() {
  ...
  $('.container-prog[data-hud="heal"]').css({
    background:
      "linear-gradient(0deg, rgba(231,189,136,0.5) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-icon[data-hud="heal"]').css({
    color: "linear-gradient(0deg, rgba(231,189,136,1) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-prog[data-hud="armour"]').css({
    background:
      "linear-gradient(0deg, rgba(184,168,255,0.5) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-icon[data-hud="armour"]').css({
    color: "linear-gradient(0deg, rgba(184,168,255,1) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-prog[data-hud="hunger"]').css({
    background:
      "linear-gradient(0deg, rgba(86,232,242,0.5) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-icon[data-hud="hunger"]').css({
    color: "linear-gradient(0deg, rgba(86,232,242,1) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-prog[data-hud="thirst"]').css({
    background:
      "linear-gradient(0deg, rgba(111,212,13,0.5) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-icon[data-hud="thirst"]').css({
    color: "linear-gradient(0deg, rgba(111,212,13,1) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-prog[data-hud="stamina"]').css({
    background:
      "linear-gradient(0deg, rgba(255,255,255,0.5) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-icon[data-hud="stamina"]').css({
    color: "linear-gradient(0deg, rgba(255,255,255,1) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-prog[data-hud="pstress"]').css({
    background:
      "linear-gradient(0deg, rgba(197, 7, 7, 0.5) 0%, rgba(0,0,0,0) 100%)",
  });
  $('.container-icon[data-hud="pstress"]').css({
    color: "linear-gradient(0deg, rgba(197, 7, 7,1) 0%, rgba(0,0,0,0) 100%)",
  });
...
function addCommas(inputText) {
  ...
  const callback = (match, p1, p2, p3) =>
    `${p1.replace(commaPattern, callback)}.${p2}${p3 ? p3 : ""}`;
  return inputText.replace(commaPattern, callback);
}

function sendClientMapType() {
  $.post(
    "http://wais-hudv4/setMapSelection",
    JSON.stringify({
      map: mapType,
    })
  );
...
function cinematicMode(boolean) {
  if (boolean) {
    $(".cinematic-top, .cinematic-bottom").fadeIn(250);
    $(
      ".container, .clock, .information, .keybind-list, .notification-list, .street-mic, .car-hud"
...
function buildGang(job, grade) {
  if (job == "none") {
    $("#gang-container").remove();
    return;
  }
  if ($("#gang-container").length) {
    $("#player-gang").html(`${job} - ${grade}`);
    return;
  }
  const newDiv = `
        <div id="gang-container" class="job">
            <span id="player-gang">${job} - ${grade}</span><i class="fa-solid fa-masks-theater"></i>
        </div>
    `;
  $("#job-container").after(newDiv);
}

function sendSpeedType() {
  $.post(
    "http://wais-hudv4/speedType",
    JSON.stringify({
      type: speedType,
    })
  );
